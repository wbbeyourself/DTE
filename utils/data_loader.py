...
class Text2SQLDataset(Dataset):
    ...
    def _to_tensor(self, data_input: Dict):
        ...
        data_input['column_indices'] = _convert_index_spans_to_tensor(data_input['column_indices'])
        data_input['value_indices'] = _convert_index_spans_to_tensor(data_input['value_indices'])
    ...
    def _encode_examples(self, examples: List[Text2SQLExample], sort_by_length: bool, n_processes: int = None):
        ...
        info("Ignore {} examples with encode length > {}".format(len(examples) - len(encoded_examples), self.max_enc_length))
